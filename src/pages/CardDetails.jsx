...
<div className="w-full h-[463px] bg-[#9538E2] text-center text-white space-y-3  py-10">
  ...
  <p className=" max-w-[796px] mx-auto">Explore the latest gadgets that will take your experience to the next level. From smart devices to the coolest accessories, we have it all!</p>
</div>


<div className="hero max-w-[1020px] bg-base-200 mx-auto rounded-xl relative -top-[200px]">
    <div className="hero-content flex-col lg:flex-row gap-6">
    <img className="max-w-[424px] max-h-[503px] rounded-2xl"
      src={image} />
    <div className="space-y-3">
      <h3 className="text-3xl semi-bold">{title}</h3>
      <p className="text-lg text-gray-600 font-regular">Price: ${price}</p>
      <span className="badge bg-[rgba(47,156,8,0.1)] p-3 font-bold">In Stock</span>
      ...
      <div className="flex flex-col justify-center gap-6">
          ...
          <h4 className="text-xl font-bold">Rating <i className="text-yellow-300 fa-solid fa-star"></i></h4>
          <div>
